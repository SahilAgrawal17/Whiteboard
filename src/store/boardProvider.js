...
const BoardProvider = ({children}) =>{
    ...
    const boardMouseDownHandler = (event, toolbarState) => {
        ...
        dispatchBoardAction({
            ...
            payload: {
                clientX,
                clientY,
                stroke: toolbarState[boardState.activeToolItem]?.stroke,
                fill: toolbarState[boardState.activeToolItem]?.fill,
                size: toolbarState[boardState.activeToolItem]?.size,
            }
        })
    };
